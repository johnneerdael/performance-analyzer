...
class DefaultReportGenerator {
    ...
    generateConfigurationOverview(analysis) {
        ...
        sortedConfigs.forEach((config) => {
            overview.push(`| ${config.rank} | ${config.configuration} | ${config.overallScore.toFixed(2)} | ${config.bandwidthScore.toFixed(2)} | ${config.latencyScore.toFixed(2)} | ${config.reliabilityScore.toFixed(2)} |`);
        });
    ...
    generateBandwidthTable(metrics) {
        ...
        metrics.forEach((metric) => {
            table.push(`| ${metric.configuration} | ${metric.avgBandwidthMbps.toFixed(2)} | ${metric.medianBandwidthMbps.toFixed(2)} | ${metric.maxBandwidthMbps.toFixed(2)} | ${metric.minBandwidthMbps.toFixed(2)} | ${metric.standardDeviation.toFixed(2)} | ${metric.percentile95.toFixed(2)} | ${metric.percentile99.toFixed(2)} |`);
        });
        return table.join("\n");
    }
    /**
    ...
    generateLatencyTable(metrics) {
        ...
        metrics.forEach((metric) => {
            table.push(`| ${metric.configuration} | ${metric.avgLatencyMs.toFixed(2)} | ${metric.medianLatencyMs.toFixed(2)} | ${metric.maxLatencyMs.toFixed(2)} | ${metric.minLatencyMs.toFixed(2)} | ${metric.jitterMs.toFixed(2)} |`);
        });
        return table.join("\n");
    }
    /**
    ...
    generateReliabilityTable(metrics) {
        ...
        metrics.forEach((metric) => {
            table.push(`| ${metric.configuration} | ${(metric.successRate * 100).toFixed(2)} | ${(metric.retransmitRate * 100).toFixed(2)} | ${(metric.packetLossRate * 100).toFixed(2)} | ${metric.errorCount} |`);
        });
        return table.join("\n");
    }
    /**
    ...
    generateCpuUtilizationTable(metrics) {
        ...
        metrics.forEach((metric) => {
            table.push(`| ${metric.configuration} | ${(metric.avgHostCpuUsage * 100).toFixed(2)} | ${(metric.avgRemoteCpuUsage * 100).toFixed(2)} | ${(metric.maxHostCpuUsage * 100).toFixed(2)} | ${(metric.maxRemoteCpuUsage * 100).toFixed(2)} |`);
        });
        return table.join("\n");
    }
    /**
    ...
    generateDnsPerformanceTable(metrics) {
        ...
        metrics.forEach((metric) => {
            table.push(`| ${metric.configuration} | ${metric.avgResponseTimeMs.toFixed(2)} | ${metric.medianResponseTimeMs.toFixed(2)} | ${(metric.successRate * 100).toFixed(2)} |`);
        });
        return table.join("\n");
    }
    /**
